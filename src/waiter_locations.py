...
ROOM2_ENTRANCE_KITCHEN = (Point(-1.35, 3.15), Orientation(1, 0), False) # Entrance to room2 coming from kitchen
...
ROOM3_ENTRANCE = (Point(-1.37, 6.48), Orientation(1, 0), False)
