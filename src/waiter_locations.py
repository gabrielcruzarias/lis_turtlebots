...
ROOM1_EXIT = (Point(-0.75, 0.02), Orientation(0, 1))
...
# PATHS
PATH_WAYPOSES = {}
PATH_WAYPOSES[("room1", "room2")] = [ROOM1_PRE_EXIT, ROOM1_EXIT, ROOM1_ROOM2, ROOM2_ENTRANCE_KITCHEN, ROOM2]
PATH_WAYPOSES[("room1", "room3")] = [ROOM1_PRE_EXIT, ROOM1_EXIT, ROOM1_ROOM2, ROOM2_HALLWAY, ROOM2_ROOM3, ROOM3_ENTRANCE, ROOM3]
PATH_WAYPOSES[("room1", "kitchen1")] = [ROOM1_PRE_EXIT, ROOM1_EXIT, KITCHEN1]
PATH_WAYPOSES[("room1", "kitchen2")] = [ROOM1_PRE_EXIT, ROOM1_EXIT, KITCHEN2]
...
PATH_WAYPOSES[("room2", "kitchen1")] = [ROOM2_EXIT, ROOM1_ENTRANCE_OTHER_ROOMS, ROOM1_EXIT, KITCHEN1]
PATH_WAYPOSES[("room2", "kitchen2")] = [ROOM2_EXIT, ROOM1_ENTRANCE_OTHER_ROOMS, ROOM1_EXIT, KITCHEN2]
...
PATH_WAYPOSES[("kitchen", "room1")] = [ROOM1_ENTRANCE_KITCHEN, ROOM1, ROOM1]
PATH_WAYPOSES[("kitchen", "room2")] = [ROOM1_ENTRANCE_KITCHEN, ROOM1_ROOM2, ROOM2_ENTRANCE_KITCHEN, ROOM2]
PATH_WAYPOSES[("kitchen", "room3")] = [ROOM1_ENTRANCE_KITCHEN, ROOM1_ROOM2, ROOM2_HALLWAY, ROOM2_ROOM3, ROOM3_ENTRANCE, ROOM3]
