...
class Waiter(MultiNavigator):
    ...
    def __init__(self, name, start_location = "room1", start_drinks_ordered = {"room1" : [], "room2" : [], "room3" : []}, start_action = {"donatello" : "GO_TO_ROOM1", "leonardo" : "GO_TO_ROOM2"}, debug = False, default_velocity = 0.3, default_angular_velocity = 0.75):
    ...
    def getDrink(self):
        ...
        self.location = "pr2"
        self.send_msg_to_pr2("turtle in place position")
        self.wait_until_msg_is("serving_turtlebot: pr2 placed object")
